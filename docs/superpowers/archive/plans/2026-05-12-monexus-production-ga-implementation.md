> **ARCHIVED — historical reference only. Do not implement from this plan.**
>
> Original baseline: `origin/master@4ed16e6`. All tasks in this plan have
> been completed and merged to master via M2–M9 milestone PRs. Worktree
> instructions and `app.ts` snippets have been superseded by the current
> codebase. Kept here for historical context.
>
