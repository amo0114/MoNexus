> **ARCHIVED — historical reference only. Do not implement from this document.**
>
> Original baseline: `origin/master@4ed16e6`. Superseded by M5–M9 merges
> (product reviews, instant-fixed delivery, merchant settlement, points,
> invite/checkin, order/inventory) and by the current product PRD at
> `docs/superpowers/specs/2026-04-30-monexus-product-prd.md`. All M2 P0
> production-readiness work has shipped. Kept here for historical context.
>
> Archived from branch `docs/production-ga-prd` on 2026-07-22.
