...
| G-CAT-PR-010 | PR 含规格、migration、监控、风险、回滚、证据索引 | Passed (staging scope) | Protected workflow `31929179740`, `cmi-release-rehearsal.md`, and `cmi-owner-handoff.md`; production monitoring/restore is separately authorized |
