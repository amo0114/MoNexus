...
| 2026-08-16 | (Card D) | D / T-UX-005/006 | `npm test -- storeFeed.test.ts StorePage.cmi.test.tsx` | exit 0; 12 feed-unit + 6 StorePage component tests | StorePage renders one blended feed; no empty shelf; rec 500 fail-open; disclosure text+aria; commit pending |
| 2026-08-16 | (Card E) | E / T-UX-007/008 | `npm test -- AdminEditorialManager AdminCategoryManager StorePage.cmi` + copy scan | exit 0; 21+19+6 component tests; consumer-host static scan zero hits | frozen vocab, blockReason/SLA/capacity/null projections, Editorial search selector, Category code/icon advanced; commit pending |
