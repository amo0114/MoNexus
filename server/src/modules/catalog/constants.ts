...
export const CATALOG_ERROR_CODES = {
  ...
  // Archived ExternalCatalogLink re-import / sync guidance (PR-M4).
  PRODUCT_ARCHIVED: 'PRODUCT_ARCHIVED',
  PRODUCT_PURGE_BLOCKED: 'PRODUCT_PURGE_BLOCKED',
  DEFAULT_OFFER_ARCHIVE_BLOCKED: 'DEFAULT_OFFER_ARCHIVE_BLOCKED',
  FAKA_OPEN_TASK: 'FAKA_OPEN_TASK',
  FAKA_PRICE_CHANGE_REQUIRES_CONFIRM: 'FAKA_PRICE_CHANGE_REQUIRES_CONFIRM',
  FAKA_ACTION_NOT_IN_DIFF: 'FAKA_ACTION_NOT_IN_DIFF',
  DEFAULT_OFFER_REQUIRES_ACTIVE: 'DEFAULT_OFFER_REQUIRES_ACTIVE',
  ...
  // Cover / default-cover gates (SPEC-CMI-UX-001 §5.4/§6.2).
  COVER_REQUIRED: 'COVER_REQUIRED',
  COVER_INVALID: 'COVER_INVALID',
  // SPEC-PRODUCT-COMMERCE-002 §12.1
...
/** Product.visibility (SPEC-PRODUCT-COMMERCE-002 §3.1 / §6.1). */
...
/** Frozen platform-assistance policy (SPEC-PRODUCT-COMMERCE-002 §1.1 / §7.2). */
export const ASSURANCE_POLICY_CODE = 'platform_assistance_v1' as const
export const ASSURANCE_POLICY_TEXT =
