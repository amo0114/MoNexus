...
import { authenticate, requireActiveUser, requireMfaIfAdmin, requireVerifiedEmail } from '../../middlewares/auth.js'
...
router.post('/:id/review', validate({ params: idParamSchema, body: reviewBodySchema }), requireVerifiedEmail, reviewsController.createForOrder)
router.put('/:id/review', validate({ params: idParamSchema, body: reviewBodySchema }), requireVerifiedEmail, reviewsController.updateForOrder)
